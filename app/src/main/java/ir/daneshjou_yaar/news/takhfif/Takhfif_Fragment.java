...
public class Takhfif_Fragment extends Fragment implements Recycler_Item_Click_Listener.OnRecyclerClickListener ,PaginationAdapterCallback {
    ...
    private News_Takhfif_Service mNews_service;
    ...
    public static Takhfif_Fragment newInstance() {
        Takhfif_Fragment fm = new Takhfif_Fragment();
        return fm;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNews_service = News_api.getClient().create(News_Takhfif_Service.class);

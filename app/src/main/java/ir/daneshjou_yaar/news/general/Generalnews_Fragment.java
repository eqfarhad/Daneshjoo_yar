package ir.daneshjou_yaar.news.general;
...
import ir.daneshjou_yaar.news.News_Service;
...
public class Generalnews_Fragment extends Fragment implements Recycler_Item_Click_Listener.OnRecyclerClickListener ,PaginationAdapterCallback {
    private static final String TAG = "Generalnews_Fragment";
    ...
    private News_Service mNews_service;
    ...
    public static Generalnews_Fragment newInstance() {
        Generalnews_Fragment fm = new Generalnews_Fragment();
        return fm;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNews_service = News_api.getClient().create(News_Service.class);
...
/*
    ...
    private Call<GetDataFromWeb> callGET_ADS_sApi() {
        return mNews_service.GET_DATA_FROM_WEB_CALL(currentPage);
    }

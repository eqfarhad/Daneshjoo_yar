...
public class BackgroundTask_Increase_counter extends AsyncTask<String , Integer , String> {
    private static final String TAG = "BackgroundTask_Increase";

    Context ctx;

    public BackgroundTask_Increase_counter(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        if (method.equalsIgnoreCase("counter")){
        ...
        }else if (method.equalsIgnoreCase("emotion")){

            String post_id = params[1];
            String emotion = params[2];
            ...
            try {
                ...
                String data = URLEncoder.encode("emotion_id" , "UTF-8")+"="+URLEncoder.encode(post_id , "UTF-8")+"&"+
                        URLEncoder.encode("emotion_value" , "UTF-8")+"="+URLEncoder.encode(emotion , "UTF-8");

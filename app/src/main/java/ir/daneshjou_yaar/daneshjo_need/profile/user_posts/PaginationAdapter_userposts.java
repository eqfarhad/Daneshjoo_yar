...
public class PaginationAdapter_userposts extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PaginationAdapter_userposts(Context context) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.fragment_daneshjo_need_profile_userpost_item_recycle_view, parent, false);
        viewHolder = new AdvertiseVH(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                final AdvertiseVH adsVH = (AdvertiseVH) holder;
                ...
                adsVH.visit.setText(ad_model.getCounter());
                break;
            case LOADING:
...
//                Do nothing
    ...
    */
    ...
    public void remove(Ad advertise) {
        int position = ads.indexOf(advertise);
        if (position > -1) {
            ads.remove(position);
    ...
    */
     ...
     */
    protected class AdvertiseVH extends RecyclerView.ViewHolder {
        ...
        public AdvertiseVH(View itemView) {
            ...
            this.image = (ImageView) itemView.findViewById(R.id.profile_userpost_recycle_image);
            this.title = (Custom_Text_View) itemView.findViewById(R.id.profile_userpost_recycle_title);
            this.price = (Custom_Text_View) itemView.findViewById(R.id.profile_userpost_recycle_price);
            this.date = (Custom_Text_View) itemView.findViewById(R.id.profile_userpost_recycle_date);
            this.visit = (Custom_Text_View) itemView.findViewById(R.id.profile_userpost_recycle_visit);
            this.mProgress = (ProgressBar) itemView.findViewById(R.id.progressBar_profile_userpost_ad);
            this.mProgress_detail = (ProgressBar) itemView.findViewById(R.id.profile_userpost_recycle_loading_detail);
        }
    }
